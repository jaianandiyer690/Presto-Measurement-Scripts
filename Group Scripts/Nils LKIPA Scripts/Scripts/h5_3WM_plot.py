...
for i in range(start_num, num_curves, step):
    ...
    legend.append(f"Pump_amp: {pump_amp:.2f}")
...
ax[0].legend(legend, title = "Pump amplitude \n (V Full Scale)")
fig.suptitle(f"Measurement: {meas}")
# fig.suptitle(r"DC bias at 13.3 $\mu$A, Pump amplitude at 1.2 dBm after amplifiers")
